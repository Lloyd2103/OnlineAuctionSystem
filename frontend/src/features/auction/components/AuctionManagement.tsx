...
import { useAuctionManagementLogic } from '../hooks/useAuctionManagementLogic';
...
function ConfirmDialog({ open, onConfirm, onCancel, title, message }: {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-10 bg-card rounded-2xl shadow-2xl p-6 w-full max-sm:w-[90%] max-w-sm border">
    ...
    return (
        <div className="p-6 bg-background min-h-screen max-w-7xl mx-auto">
            ...
            <Modal open={createOpen} onClose={() => setCreateOpen(false)}>
                <AuctionCreateForm
                    mode="create"
                    onSuccess={() => { setCreateOpen(false); fetchAuctions(); }}
            ...
            <Modal open={!!editTarget} onClose={() => setEditTarget(null)}>
                {editTarget && (
                    <AuctionCreateForm
                        ...
                        onSuccess={() => { setEditTarget(null); fetchAuctions(); }}
